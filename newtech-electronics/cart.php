    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php include "header.php";?>
                ...
                <div class="col-12 pt-3" style="background-color: whitesmoke;">
                                            ...
                                            <div class="row g-0">
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <span class="fw-bold text-black fs-5">Junox Nujan</span>&nbsp;
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $product_data["description"]; ?>" title="Product Details">
                                                        <img src="resource/mobile_images/Canon-EOS-R6.jpeg" class="img-fluid rounded-start" style="max-width: 200px;">
                                                    </span>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <h3 class="card-title">Canon EOS R6</h3>
                                                        ...
                                                        <span class="fw-bold text-black fs-5">Rs. 947,500 .00</span>
                                                        <br>
                                                        ...
                                                        <span class="fw-bold text-black fs-5">Rs. 3500 .00</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end mb-3">
                                        <span class="fs-6 fw-bold">Rs. 947,500 .00</span>
                                    </div>
                                    ...
                                    <div class="col-6 text-end">
                                        <span class="fs-6 fw-bold">Rs. 3500 .00</span>
                                    </div>
                                    ...
                                    <div class="col-6 mt-2 text-end">
                                        <span class="fs-4 fw-bold">Rs. 951000 .00</span>
                                    </div>
